...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "cython_utils.nms",
        "sources": [
            "./cython_utils/nms.pyx"
        ]
    },
    "module_name": "cython_utils.nms"
}
END: Cython Metadata */
...
extern int __pyx_module_is_main_cython_utils__nms;
 ...
 */
        ...
        __pyx_t_27 = 3;
        __pyx_t_10 = ((__pyx_f_12cython_utils_3nms_box_iou_c((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_8 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_9)) ))), (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_14 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_15)) ))), (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_16 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_17)) ))), (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_18 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_19)) ))), (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_20 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_21)) ))), (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_22 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_23)) ))), (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_24 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_25)) ))), (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_final_bbox.data + __pyx_t_26 * __pyx_v_final_bbox.strides[0]) )) + __pyx_t_27)) )))) >= 0.4) != 0);
        if (__pyx_t_10) {
